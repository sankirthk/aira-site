...
export function OrganizationCategoryIcon({
  ...
  return (
    ...
    >
      <path
        d="M18 27H35L39 32H66V61C66 65 63 68 59 68H25C21 68 18 65 18 61V27Z"
        fill="#F5F2EC"
        stroke="#2B2B2B"
        strokeWidth="2.5"
      ...
      />
      <path
        d="M32 19L34.6 24.2L40 24.9L36 28.7L36.9 34L32 31.4L27.1 34L28 28.7L24 24.9L29.4 24.2L32 19Z"
        fill={accentColor}
        opacity="0.9"
      />
    </svg>
